...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2021 a las 00:38:37
...
(1, 'Asesor', 'Carlos Bejarano', 3024075378, 'cabejarano21@gmal.com', 1, 1, 1),
(2, 'Asesor', 'Jhonnathan Castro Galeano', 3128990077, 'actualizar@gmal.com', 1, 2, 1),
...
(1, 'Ajuste parametros por el Asesor de Soporte'),
(2, 'Ajuste parametros por el Usuario'),
(3, 'Actualización del sistema'),
(4, 'Capacitación'),
(5, 'Desconocimiento del sistema'),
(6, 'Ejecución rutinas especiales y consultas a la BD'),
(7, 'Error del sistema'),
(8, 'Error del usuario'),
(9, 'Error de Parametros'),
(10, 'En Desarrollo'),
(11, 'Inconveniente tecnico de la Red'),
(12, 'Mantenimiento Base de Datos'),
(13, 'Novedad no identificada');
...
(4, 900086836, 'Apple Inc.', 'Arthur D. Levinson', 665999656, 'cabejarano21@gmail.com', '2021-02-01 00:00:00', '2021-02-28 00:00:00', 'Contrato a un año con renovación a cinco años', '2021-02-01 00:00:00', '2021-03-14 00:00:00', 1, 3, 1),
(6, 900083865, 'Colpensiones', 'Pedro Nel Ospina', 333568958, 'cabejarano21@gmail.com', '2020-01-01 00:00:00', '2021-02-28 00:00:00', 'Contrato a un año con renovación a 6 meses', '2021-02-01 00:00:00', '2021-04-30 00:00:00', 1, 2, 1);
*/
-- --------------------------------------------------------
...
INSERT INTO `user` (`id`, `username`, `name`, `email`, `password`, `profile_pic`, `is_active`, `created_at`, `rol_id`) VALUES
(1, 'admin', 'Carlos Bejarano Barbosa', 'cabejarano21@gmail.com', '123456', 'logo.png', 1, '2019-11-05 12:05:45', 1);
